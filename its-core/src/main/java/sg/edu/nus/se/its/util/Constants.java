...
public class Constants {
   ...
   */
  public static final List<String> COMP_OPS = new ArrayList<>(Arrays.asList("<=", "<", ">", ">=",
      "==", "!="));

  /**
   * Constant ArrayList of arithmetic operators.
   */
  public static final List<String> ARITH_OPS = new ArrayList<>(Arrays.asList("+", "-", "*", "/",
      "%"));
  ...
  public static final List<String> FUNCS = new ArrayList<>(Arrays.asList("floor", "ceil", "pow",
      "abs", "sqrt", "log2", "log10", "log", "exp"));

  public static final Map<String, String> BINARY_OPS_PYTHON = new HashMap<>(Map.ofEntries(
      entry("And", "and"), entry("Or", "or"), entry("Add", "+"),
      entry("AssAdd", "+"), entry("Sub", "-"),
      entry("Mult", "*"), entry("Div", "/"), entry("Mod", "%"),
      entry("Pow", "**"), entry("LShift", "<<"), entry("RShift", ">>"),
      entry("BitOr", "|"), entry("BitAnd", "&"), entry("BitXor", "^"),
      entry("FloorDiv", "//"), entry("Eq", "=="), entry("NotEq", "!="),
      entry("Lt", "<"), entry("LtE", "<="), entry("Gt", ">"),
      entry("GtE", ">="), entry("Is", "is"), entry("IsNot", "is not"),
