...
public class Function implements JsonSerializable, Executable {
  ...
  private int initloc;
  private int endloc; // TODO YN: not used?
   ...
   * name) and the return type. TODO YN is this correct? Can we have Type class instead of String?
   */
  ...
  /**
   * Retrieves the number of incoming transitions into a code location. TODO YN: correct?
   */
  ...
  /**
   * Removing either the true or false branch from locations that are not longer in use.
   * This is akin to removing an edge in the Control Flow Graph.
   *
   ...
   * This method will throw an error if the location to be
   * removed does not exist in the first place.
   *
   * @param loc location to be removed
   */
