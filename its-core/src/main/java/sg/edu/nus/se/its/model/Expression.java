...
public abstract class Expression implements Executable, JsonSerializable {
  ...
  /**
   * TODO YN Meaning is not clear, can it be removed.
   */
  ...
  /**
   * Method call to replace an expression iff the particular expression matches varName.
   * Note that if this expression object is not called varName, it will just return this
