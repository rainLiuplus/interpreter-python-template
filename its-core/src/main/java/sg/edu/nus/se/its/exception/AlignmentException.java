...
/**
 * Custom exception for Alignment exceptions during structural alignment.
 */
public class AlignmentException extends Exception {
  ...
  public static final AlignmentException FAILED =
      new AlignmentException("Alignment failed");
}
